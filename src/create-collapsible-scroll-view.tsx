...
export function createCollapsibleScrollView<P extends object>(Component: ComponentClass<P>) {
  ...
  return React.forwardRef<
    ForwardRefExoticComponent<CollapsibleScrollViewProps & RefAttributes<ComponentClass<P>>>,
